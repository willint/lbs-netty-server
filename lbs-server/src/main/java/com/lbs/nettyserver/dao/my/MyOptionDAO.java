...
public class MyOptionDAO {
	 ...
	 * @param liveMessage
	 */
	public void saveUserSuggest(UserSuggest userSuggest){
		this.sessionFactory.getCurrentSession().save(userSuggest);
	...
	/**
	 * 根据用户id获取用户昨天发布的现场消息总数
	 * @param userId
	 * @return
	 * @throws Exception 
	 */
	public Object getLiveMessageYesterdayTotalByUserId(String userId) throws Exception{
		
		String sql="SELECT\r\n" + 
				"	COUNT (*) AS \"liveMessageYesterdayTotal\"\r\n" + 
				"FROM\r\n" + 
				"	t_live_message tlm\r\n" + 
				"WHERE\r\n" + 
				"	tlm.user_id = :userId\r\n" + 
		...
		Map<String,Object> params=new HashMap<String,Object>();
		params.put("userId", userId);
		return baseDao.selectNativeSqlUniqueResult(sql, params, "liveMessageYesterdayTotal");
	}
	...
	/**
	 * 根据用户id获取用户得到赞和点出的赞的总数
	 * @param userId
	 * @return
	 */
	public MyGetGetZanAndPutZanTotalResponse getZanAndPutZanTotalByUserId(String userId){
		String sql="SELECT\r\n" + 
				"	tuc.get_zan_total AS \"getZanTotal\",\r\n" + 
				"	tuc.put_zan_total AS \"putZanTotal\"\r\n" + 
				"FROM\r\n" + 
				"	t_userinfo_count tuc\r\n" + 
				"WHERE\r\n" + 
				"	tuc.user_id = :userId";
		...
		List<MyGetGetZanAndPutZanTotalResponse> list=new ArrayList<MyGetGetZanAndPutZanTotalResponse>();		
		try {
			list=baseDao.selectNativeSqlList(sql, params, MyGetGetZanAndPutZanTotalResponse.class);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	/**
	 * 根据用户id获取用户得到踩和点出的踩的总数
	 * @param userId
	 * @return
	 */
	public MyGetGetCaiAndPutCaiTotalResponse getCaiAndPutCaiTotalByUserId(String userId){
		String sql="SELECT\r\n" + 
				"	tuc.get_cai_total AS \"getCaiTotal\",\r\n" + 
				"	tuc.put_cai_total AS \"putCaiTotal\"\r\n" + 
				"FROM\r\n" + 
				"	t_userinfo_count tuc\r\n" + 
				"WHERE\r\n" + 
				"	tuc.user_id = :userId";
		...
		List<MyGetGetCaiAndPutCaiTotalResponse> list=new ArrayList<MyGetGetCaiAndPutCaiTotalResponse>();		
		try {
			list=baseDao.selectNativeSqlList(sql, params, MyGetGetCaiAndPutCaiTotalResponse.class);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	/**
	 * 根据用户id获取现场我得到的评论和发表的评论的总
	 * @param userId
	 * @return
	 */
	public MyGetGetAndPutLiveCommentTotalResponse getGetAndPutLiveCommentTotalByUserId(String userId){
		String sql="SELECT\r\n" + 
				"	tuc.get_comment_total AS \"getLiveCommentTotal\",\r\n" + 
				"	tuc.put_comment_total AS \"putLiveCommentTotal\"\r\n" + 
				"FROM\r\n" + 
				"	t_userinfo_count tuc\r\n" + 
				"WHERE\r\n" + 
				"	tuc.user_id = :userId";
		...
		List<MyGetGetAndPutLiveCommentTotalResponse> list=new ArrayList<MyGetGetAndPutLiveCommentTotalResponse>();		
		try {
			list=baseDao.selectNativeSqlList(sql, params, MyGetGetAndPutLiveCommentTotalResponse.class);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}

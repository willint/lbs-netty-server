...
public class MethodCodeConstants {
	 ...
	 */
	public static final String addOneUserToBlackList= "10013";//将某一用户添加至某用户的黑名单接口
	
	/**
	 * 将某一用户从用户黑名单中删除接口
	
	 */
	public static final String deletOneUserFromBlackList= "10014";//将某一用户从用户黑名单中删除接口
	
	/**
	 * 私信-拉取用户与用户之间的私信消息接口
	
	 */
	public static final String privatePullUserToUserChat= "10015";//私信-拉取用户与用户之间的私信消息接口
	
	/**
	 * 私信-拉取不在客户端私信列表中的用户的其他私信接口
	
	 */
	public static final String privatePullNotInClientChat= "10016";//私信-拉取不在客户端私信列表中的用户的其他私信
	
	/**
	 * 私信-删除用户与用户之间的私信
	
	 */
	public static final String privateDeleteUserToUserChat= "10017";//私信-删除用户与用户之间的私信
	 ...
	 *拉取吐槽自由聊天消息
	 */
	public static final String pullVomitFreeChat= "30006";//拉取吐槽自由聊天消息
	 ...
	 * 我的-获取用户昨天发布的现场消息
	 */
	public static final String myGetLiveMessageYesterdayTotal= "50029";//我的-获取用户昨天发布的现场消息
	
	/**
	 * 我的-获取我得到的赞和点出的赞的总数接口
	 */
	public static final String myGetGetZanAndPutZanTotal= "50030";//我的-获取我得到的赞和点出的赞的总数接口
	
	/**
	 * 我的-获取我得到的踩和点出的踩的总数接口
	 */
	public static final String myGetGetCaiAndPutCaiTotal= "50031";//我的-获取我得到的踩和点出的踩的总数接口
	
	/**
	 * 我的-获取现场我得到的评论和发表的评论的总数接口
	 */
	public static final String myGetGetAndPutLiveCommentTotal= "50032";//我的-获取现场我得到的评论和发表的评论的总数接口
	
	/**
	 * 我的-用户意见反馈接口
	 */
	public static final String myUserSuggest= "50033";//我的-用户意见反馈接口
	 ...
	 * 智囊-发表智囊消息
	 */
	public static final String smartPublishSmartMessage= "60007";//智囊-发表智囊消息

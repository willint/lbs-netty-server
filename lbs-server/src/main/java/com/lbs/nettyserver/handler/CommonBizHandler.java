...
import com.lbs.nettyserver.service.functionsevice.common.AddUserBlackListService;
...
import com.lbs.nettyserver.service.functionsevice.common.DeleteOneBlackUserService;
...
import com.lbs.nettyserver.service.functionsevice.common.PrivateDeleteUserToUserChatService;
import com.lbs.nettyserver.service.functionsevice.common.PrivatePullNotInClientChatService;
import com.lbs.nettyserver.service.functionsevice.common.PrivatePullUserToUserChatService;
...
import com.lbs.nettyserver.service.functionsevice.my.MyGetGetAndPutLiveCommentTotalService;
import com.lbs.nettyserver.service.functionsevice.my.MyGetGetCaiAndPutCaiTotalService;
...
import com.lbs.nettyserver.service.functionsevice.my.MyGetGetZanAndPutZanTotalService;
...
import com.lbs.nettyserver.service.functionsevice.my.MyGetLiveMessageYesterdayTotalService;
...
import com.lbs.nettyserver.service.functionsevice.my.MyUserSuggestService;
...
import com.lbs.nettyserver.service.functionsevice.smart.SmartPublishMessageService;
import com.lbs.nettyserver.service.functionsevice.vomit.VomitPullFreeChatService;
...
public class CommonBizHandler {
	...
	@Autowired
	private DeleteOneBlackUserService deleteOneBlackUserService;
	
	@Autowired
	private AddUserBlackListService addUserBlackListService;
	
	@Autowired
	private PrivatePullUserToUserChatService privatePullUserToUserChatService;
	
	@Autowired
	private PrivatePullNotInClientChatService privatePullNotInClientChatService;
	
	@Autowired
	private PrivateDeleteUserToUserChatService privateDeleteUserToUserChatService;
	...
	@Autowired
	private VomitPullFreeChatService vomitPullFreeChatService;
	...
	@Autowired
	private MyGetLiveMessageYesterdayTotalService myGetLiveMessageYesterdayTotalService;
	
	@Autowired
	private MyGetGetZanAndPutZanTotalService myGetGetZanAndPutZanTotalService;
	
	@Autowired
	private MyGetGetCaiAndPutCaiTotalService myGetGetCaiAndPutCaiTotalService;
	
	@Autowired
	private MyUserSuggestService myUserSuggestService;
	
	@Autowired
	private MyGetGetAndPutLiveCommentTotalService myGetGetAndPutLiveCommentTotalService;
	...
	@Autowired
	private SmartPublishMessageService smartPublishMessageService;
	...
	public JSONObject handleMethod(ReqHead head, JSONObject data){
		...
		try {
			...
			case MethodCodeConstants.getOneUserPower:
				...
				break;
			case MethodCodeConstants.deletOneUserFromBlackList:
				body = deleteOneBlackUserService.handleBiz(data);
				break;
			case MethodCodeConstants.addOneUserToBlackList:
				body = addUserBlackListService.handleBiz(data);
				break;
			case MethodCodeConstants.privatePullUserToUserChat:
				body = privatePullUserToUserChatService.handleBiz(data);
				break;
			case MethodCodeConstants.privatePullNotInClientChat:
				body = privatePullNotInClientChatService.handleBiz(data);
				break;
			case MethodCodeConstants.privateDeleteUserToUserChat:
				body = privateDeleteUserToUserChatService.handleBiz(data);
				break;
			...
			case MethodCodeConstants.getJoinedVomitSpecial:
				...
				break;
			case MethodCodeConstants.pullVomitFreeChat:
				body = vomitPullFreeChatService.handleBiz(data);
				break;
			...
			case MethodCodeConstants.myDeleteOneLiveMessage:
				...
				break;
			case MethodCodeConstants.myGetLiveMessageYesterdayTotal:
				body = myGetLiveMessageYesterdayTotalService.handleBiz(data);
				break;
			case MethodCodeConstants.myGetGetZanAndPutZanTotal:
				body = myGetGetZanAndPutZanTotalService.handleBiz(data);
				break;
			case MethodCodeConstants.myGetGetCaiAndPutCaiTotal:
				body = myGetGetCaiAndPutCaiTotalService.handleBiz(data);
				break;
			case MethodCodeConstants.myGetGetAndPutLiveCommentTotal:
				body = myGetGetAndPutLiveCommentTotalService.handleBiz(data);
				break;
			case MethodCodeConstants.myUserSuggest:
				body = myUserSuggestService.handleBiz(data);
				break;
			...
			case MethodCodeConstants.smartPublishComment:
				...
				break;
			case MethodCodeConstants.smartPublishSmartMessage:
				body = smartPublishMessageService.handleBiz(data);
				break;
			default:
				break;
			}						

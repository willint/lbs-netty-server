	 ...
	 private static double rad(double d)  
	    ...
	    public static void main(String[] args)
	    	...
	    	System.out.println(a+b);
    		      System.out.println(LantitudeLongitudeDist(102.7768,25.987839,102.7868,25.998413));
    		      System.out.println((0.8*a+0.05*b+0.15*c));
	    	  
    		      String[] testStrArry=new String[]{"wdsde234","dwdede"};
    		      StringBuffer sb=new StringBuffer();
    		    for(int i=0;i<testStrArry.length;i++){
    		    	sb.append("\""+testStrArry[i]+"\"");
    		    	if((i+1)!=testStrArry.length){
    		    		sb.append(",");
    		    	}
    		    }
